...
{
    public class Features10Day
    {
        public int forecast10day { get; set; }
    }

    public class Response10Day
    {
        public string version { get; set; }
        public string termsofService { get; set; }
        public Features10Day features { get; set; }
    }
    ...
    public class TenDayForecastResult
    {
        public Response10Day response { get; set; }
